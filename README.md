...
1. What is the DOM?
DOM, stands for the Document Object Model. This is the thing that gives javascript access to the HTML.
2. What is an event?
Anything that happens on the web page which will change the Document.
3. What is an event listener?
An event listener is something that will tell an event to fire, causing javascript to change the DOM.
4. Why would we convert a NodeList into an Array?
If you change a NodeList into an Array you get access to all the nifty Array methods.
5. What is a component?
Essentially its an Object/Class/something you can refer to, so that it can do nifty things int the future.
### Git Set up
